...
namespace Fleet_Command.Menus {
    public class WinMenu : Menu<MenuComponent> {
        public WinMenu(FC game)
            : this(game, Vector2.Zero, Vector2.Zero, null, Color.Transparent) {
        }

        public WinMenu(FC game, Vector2 relPos, Vector2 relSize)
            : this(game, relPos, relSize, null, Color.Transparent) {
        }

        public WinMenu(FC game, Vector2 relPos, Vector2 relSize, string bckgrnd)
            : this(game, relPos, relSize, bckgrnd, Color.Transparent) {
        }

        public WinMenu(FC game, Vector2 relPos, Vector2 relSize, Color color)
            : this(game, relPos, relSize, null, color) {
        }

        public WinMenu(FC game, Vector2 relPos, Vector2 relSize, string bckgrnd, Color color)
            ...
            MenuComponent title = new MenuComponent(game,
                ...
                new Vector2(relSize.X * .8f, relSize.Y * .5f), "You Won");
