...
namespace Fleet_Command.Game.Objects {
    public class Bullet : Projectile {
        protected new static string sprite_source = "Projectiles/bullet";
        public override string SpriteSource { get { return sprite_source; } }

        protected new static float max_speed = 10;
        ...
        public Bullet(FC game, PlayArea playArea, Vector2 pos, float angle, Player controller)
