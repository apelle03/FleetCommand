...
namespace Fleet_Command.Game.Objects {
    public class Raptor : CombatShip {
        protected new static string sprite_source = "Ships/raptor";
        ...
        public Raptor(FC game, PlayArea playArea, Vector2 pos, float angle, Player controller)
