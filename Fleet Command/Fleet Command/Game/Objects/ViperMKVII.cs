...
namespace Fleet_Command.Game.Objects {
    public class ViperMKVII : CombatShip {
        protected new static string sprite_source = "Ships/viper-mkvii";
        ...
        protected new static float max_health = 2;
        ...
        protected new static int fire_rate = 3;
        public override int FireRate { get { return fire_rate; } }

        public ViperMKVII(FC game, PlayArea playArea, Vector2 pos, float angle, Player controller)
